...
export const checkoutDiagnosticSingleQuestion = [
  {
    id: 1,
    type: "single-select",
    required: true,
    question: "What privacy threat scares you most?",
    options: [
      { value: "none", label: "Fraudulent charges on my bank or credit cards" },
      { value: "few", label: "Someone stole my identity" },
      { value: "problem", label: "Someone is stalking me" },
      { value: "way-too-many", label: "My accounts got hacked" },
      {
        value: "none-of-above1",
        label: "Someone is trying to log into my accounts",
      },
      { value: "none-of-above2", label: "Credit alerts about my information" },
      { value: "other", label: "Other", isTextInput: true },
    ],
  },
];

...
import CardPlaceholder from "../CardsListing/CardPlaceholder.vue";
...
function toggleDownloadAppModal() {
  ...
  posthogCapture(
    "dashboard_pay_post_kyc_onboarding_add_to_digital_wallet_clicked"
  );
}

const handleViewCard = () => {
  emit("continue");
  posthogCapture("dashboard_pay_post_kyc_onboarding_view_card_clicked");
};
</script>
<template>

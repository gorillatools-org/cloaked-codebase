...
const linkOptions: {
...
}[] = [
  {
    ...
    onClick: () => {
      ...
      posthogCapture(
        "dashboard_pay_post_kyc_onboarding_link_funding_credit_card_clicked"
      );
    },
  },
  {
    ...
    onClick: () => {
      ...
      posthogCapture(
        "dashboard_pay_post_kyc_onboarding_link_funding_debit_card_clicked"
      );
    },
  },
  {
    ...
    onClick: () => {
      ...
      posthogCapture(
        "dashboard_pay_post_kyc_onboarding_link_funding_bank_account_clicked"
      );
    },
  },
];

...
const linkNewFundingSource = () => {
  posthogCapture(
    "dashboard_pay_balance_due_payment_modal_link_new_funding_source_clicked"
  );
  openAddModal(() => {
...
const pay = () => {
  ...
  CardsServices.payBalanceDue(
    ...
    .then(() => {
      posthogCapture("dashboard_pay_balance_due_payment_success");
    ...
    .catch((error) => {
      ...
      posthogCapture("dashboard_pay_balance_due_payment_failed");
...
const setAmountToFullBalance = () => {
  posthogCapture(
    "dashboard_pay_balance_due_payment_modal_pay_in_full_helper_clicked"
  );

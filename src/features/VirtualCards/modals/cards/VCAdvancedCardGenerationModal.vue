...
import { computed, ref, watch, useTemplateRef, markRaw } from "vue";
...
watch(isMerchantLocked, (isLocked) => {
  posthogCapture(
    "dashboard_pay_wallet_advanced_card_generation_merchant_lock_toggled",
    {
...
watch(isCardLocked, (isLocked) => {
  posthogCapture(
    "dashboard_pay_wallet_advanced_card_generation_card_lock_toggled",
    {
      is_locked: isLocked,
    }
  );
...
watch(deactivateOption, (option) => {
  posthogCapture(
    "dashboard_pay_wallet_advanced_card_generation_deactivate_option_selected",
    {

          ...
          >
            ...
            <template #content>
              <div class="vc-wallet-protection-summary-tile__tooltip">
                ...
                >
                  When you connect a funding source and start spending on your
                  Cloaked virtual cards, you'll quickly start to see when
                  merchants attempt to make transactions without your knowledge.
                </BaseText>
              </div>
            </template>
          </UiTooltip>
      ...
      <div class="vc-wallet-protection-summary-tile__body">
        ...
        <div class="vc-wallet-protection-summary-tile__stat">
          ...
          <BaseText
            ...
            class="vc-wallet-protection-summary-tile__stat-label"
          >
            Total saved using virtual cards
          </BaseText>
        </div>
      </div>

...
import ReceivePaymentsPanel from "@/features/Wallet/ReceivePaymentsPanel.vue";
...
// TODO: Remove this function once we rollout outstanding balance banner
...
const outstandingBalance = computed(() => {
  const balance = store.state.authentication?.user?.outstanding_balance || 0;
...
const toggleSearch = () => {
  ...
  if (isSearchVisible.value) {
    posthogCapture("dashboard_pay_wallet_search_input_visible");
    focusSearchInput();
  } else {
    searchQuery.value = "";
  }
    ...
    <div class="vc-wallet-aside__wrapper">
      ...
      <div class="vc-wallet-aside__actions-container">
        <ReceivePaymentsPanel
          v-if="receivePaymentsActive && !isExpressCardGenerationEnabled"
          :active="receivePaymentsActive"
          :outstanding-balance="outstandingBalance"
        />
        <div
          v-if="isExpressCardGenerationEnabled"
          class="express-generation-container"
        >
          <VCExpressGeneration
      ...
      <div class="vc-wallet-aside__cards-container">
        <div class="vc-wallet-aside__cards-header">
          <div class="vc-wallet-aside__cards-header-title-container">
            ...
            <div
              v-if="isExpressCardGenerationEnabled"
              class="vc-wallet-aside__cards-header-sort-container"
            >

...
const streetInputRef = ref<{ $el?: HTMLElement }>();
...
function toggleManualAddress() {
  ...
  if (!showManualAddress.value) {
    streetInputRef.value?.$el?.querySelector?.("input")?.focus();
  }
}
...
function focusFirstInvalidInput() {
  ...
  const fields: Array<{
  ...
  }> = [
    {
      ...
      getEl: () =>
        firstNameInputRef.value?.$el?.querySelector?.("input") as
          | HTMLElement
          | undefined,
    },
    {
      ...
      getEl: () =>
        lastNameInputRef.value?.$el?.querySelector?.("input") as
          | HTMLElement
          | undefined,
    },
    {
      ...
      getEl: () =>
        dobInputRef.value?.$el?.querySelector?.("input") as
          | HTMLElement
          | undefined,
    },
    {
      ...
      getEl: () =>
        (streetInputRef.value?.$el?.querySelector?.("input") as
          | HTMLElement
          | undefined) ||
        (streetInputRef.value?.$el as HTMLElement | undefined),
    },
    {
      invalid: !!phoneError.value,
      getEl: () =>
        phoneInputRef.value?.$el?.querySelector?.("input") as
          | HTMLElement
          | undefined,
    },
    {
      ...
      getEl: () =>
        emailInputRef.value?.$el?.querySelector?.("input") as
          | HTMLElement
          | undefined,
    },
  ];

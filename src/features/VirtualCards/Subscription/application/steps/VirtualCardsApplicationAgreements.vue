...
import VirtualCardsAgreementsList from "@/features/VirtualCards/Subscription/application/steps/agreements/VirtualCardsAgreementsList.vue";

const emit = defineEmits(["submit"]);

onMounted(() => {
  posthogCapture("dashboard_pay_kyc_agreements_screenview");
});

const handleSubmitCtaClick = () => {
  posthogCapture("dashboard_pay_kyc_agreements_submit_clicked");
  emit("submit");
};
</script>

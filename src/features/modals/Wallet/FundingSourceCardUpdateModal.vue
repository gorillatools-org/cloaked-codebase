...
const updateFundingSource = (payload: CardFormSubmitPayload) => {
  ...
  CardsServices.updateFundingSource({
    ...
    .then(() => {
      ...
      posthogCapture(
        "dashboard_pay_wallet_funding_source_update_modal_update_success"
      );
      refetchFundingSources();
      closeModal();
    })
    .catch(() => {
      ...
      posthogCapture(
        "dashboard_pay_wallet_funding_source_update_modal_update_failed"
      );
    })
    .finally(() => {
...
watch(
  ...
  () => {
    if (fundingSource.value) {
      ...
      posthogCapture(
        "dashboard_pay_wallet_funding_source_update_modal_viewed",

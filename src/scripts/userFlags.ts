...
export const UI_NAVIGATION_COLLAPSED = "ui_navigation_collapsed";
...
export const PERMANENTLY_DISMISSED_VIRTUAL_CARD_LEAD_IN_MODAL =
  "has_permanently_dismissed_vc_lead_in_modal";
export const PERMANENTLY_DISMISSED_VIRTUAL_CARD_LEAD_IN_POST_KYC_MODAL =
  "has_permanently_dismissed_vc_lead_in_post_kyc_modal";
...
// eSim
export const ESIM_FEATURE_ANNOUNCEMENT_PRESENTED_DATE =
  "esim_feature_announcement_presented_date";
export const HAS_SEEN_UK_NUMBERS_ALERT_MODAL =
  "has_seen_uk_numbers_alert_modal";

export const FROM_SUBSCRIBE_NOW = "from_subscribe_now";

export const HAS_CLICKED_BASIC_MODE_DOWNLOAD_APP =
  "has_clicked_basic_mode_download_app";
...
export const userFlags = {
  ...
  HAS_SEEN_REQUEST_VIDEO,
  HAS_SEEN_CATEGORY_MODAL,
  IMPORT_PASSWORDS_COMPLETE,
  HAS_EXITED_DELETE_FLOW,
  STEP_IMPORT_STARTED,
  STEP_IMPORT_COMPLETED,
  HAS_SEEN_PASSPHRASE_MODAL,
  HAS_SEEN_IMPORTER_CHEAT_SHEET,
  HAS_SEEN_IMPORTER_GETTING_STARTED_VIDEO,
  HAS_SEEN_CUSTOM_FIELDS_ANNOUNCEMENT,
  HAS_SEEN_MFA_ANNOUNCEMENT,
  HAS_SEEN_CLOAKED_DAILY,
  HAS_SEEN_IDENTITY_SHARING_ANNOUNCEMENT,
  HAS_SEEN_REFERRALS_ANNOUNCEMENT,
  HAS_SEEN_TOTP_ANNOUNCEMENT,
  HAS_SEEN_AUTO_CHANGE_ANNOUNCEMENT,
  HAS_SEEN_LOCKED_NUMBERS_ANNOUNCEMENT,
  HAS_SEEN_LOCKED_NUMBERS_WARNING,
  HAS_CREATED_SAMPLE_IDENTITY,
  HAS_COMPLETED_MOBILE_ONBOARDING,
  HAS_ACTIVATED_WEB,
  HAS_ACTIVATED_PLUGIN,
  HAS_ACTIVATED_IOS,
  HAS_ACTIVATED_ANDROID,
  UI_IDENTITY_LIST_VIEW_TYPE,
  UI_NAVIGATION_COLLAPSED,
  DISMISSED_EXT_ACTION,
  DISMISSED_MOBILE_ACTION,
  DISMISSED_IMPORT_ACTION,
  DISMISSED_2FA_ACTION,

  DISMISSED_SEND_INVITE_ACTION,
  DISMISSED_VERIFICATION_ACTION,
  DISMISSED_DATA_DELETE_ACTION,
